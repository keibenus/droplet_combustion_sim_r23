...
# --- Output Options ---
OUTPUT_DIR = 'results_r23_d29_r05_cond0p85' # Changed output dir name
...
R0 = 14.5e-6 #0.05e-3       # m (Initial droplet radius, 50 micronに変更)
...
T_END = 6e-3 # s (Simulation end time, 延長)
...
ADVECTION_SCHEME = 'vanleer'   # Options: 'upwind', 'central', 'quick', 'vanleer'
...
DIFFUSION_COEFFICIENT_SCALE = 1.0
...
#MECH_FILE = 'mech_ucsd_2015.yaml'
FUGACITY_MAP_FILE = 'fugacity_map_Fluid_n-heptane_SRK.csv'

# --- Termination Criteria ---
IGNITION_CRITERION_DTDT = 0.5e7  # K/s (Max gas temperature rise rate) - Not implemented as termination in this version
