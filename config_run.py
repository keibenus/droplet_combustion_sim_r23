...
# --- Output Options ---
OUTPUT_DIR = 'results_r21_r1_r09' # Changed output dir name
...
CFL_NUMBER = 2.0             # Courant-Friedrichs-Lewy number (safety factor, typically < 1)
...
DIFFUSION_COEFFICIENT_SCALE = 1.3
